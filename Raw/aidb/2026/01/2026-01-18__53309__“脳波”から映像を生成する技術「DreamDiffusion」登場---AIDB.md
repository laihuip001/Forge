...
*   所属：Tencent AI Labなど
*   URL：[https://doi.org/10.48550/arXiv.2306.16934](https://doi.org/10.48550/arXiv.2306.16934)

![](https://ai-data-base.com/wp-content/uploads/2023/06/AIDB_53309_1-1024x576.jpg)
...
![](https://ai-data-base.com/wp-content/uploads/2023/06/AIDB_53309_3-1024x290.jpg)
...
DreamDiffusionの性能評価は、生成された画像（脳波から生成された画像）とオリジナルの画像（目の前にあった実際の画像）との間の類似性に基づいて行われました。

つまり、DreamDiffusionがうまく機能しているか（＝モデルが正確に脳波から画像を再現できるか）を評価するために、生成された画像と元の画像がどれだけ似ているかが比較されました。
